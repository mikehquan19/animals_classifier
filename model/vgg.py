...
class ConvBlock(nn.Module):
    ...
    Default block has 2 layers of convolution and max pool
    Block can have 3 layers
    """
...
class VGG16Classifier(nn.Module):
    ...
    def __init__(self):
        ...
        two_layer_blocks = [ConvBlock(3, num_channels)]
        two_layer_blocks.append(ConvBlock(num_channels, num_channels * 2))
